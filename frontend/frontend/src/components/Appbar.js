...
const pages = ['Home', 'Books', 'My Library', 'Contact & Hours'];
const settings = ['Profile', 'Account', 'My Library', 'Login'];
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page) => (
              <Button
                ...
                sx={{ my: 2, color: 'black', display: 'block', fontSize: '16px', fontWeight: '500', textDecoration: 'none' }}
              >
                {page}
              </Button>
            ))}
